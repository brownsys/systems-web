...
- **Publications**: Update the BibTeX sources in `publications/etos.bib` and `scripts/build-publications.js`, then run `npm run build:publications` to regenerate `publications/publications_generated.json`.  
